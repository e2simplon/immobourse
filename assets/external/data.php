...
echo json_encode(
    $data = array(
        [
            ...
            'featured' => 1,
            'marker_color' => "#000000",
            'marker_image' => "assets/img/items/1_1.jpg",
            'title' => "Bureau en location",
            'location' => "Zone de la Voivre",
            'city' => "Épinal",
            'category' => array(
                "Bureau",
                "location"
            ...
            'gallery' => array(
                "assets/img/items/1_1.jpg",
                "assets/img/items/1_2.jpg",
            ),
            'description' => "800m² de plein pied<br>
                                ...
                                Prix : 50 €/m²<br>
                                Localisation (canton par défaut) : EPINAL ZA : Zone de la Voivre<br>
                                Hauteur sous faîtage :<br>
                                Commission incluse : Non précisé<br>
                                Référence offre commercialisateur : <br>
                              ",
            ...
            'url' => "http://bourse-immo.vosges.cci.fr/ficheoffre_pdf.php?id=35",

            'type' => "société",
            'name' => "SOFIMARX SARL",
            'suivi' => "MARX Catherine",
            'phone' => "06 75 66 07 84",
            'email' => "cat.marx@me.com",
            'website' => "",
            'adress' => "18 chemin de la Droite du Lac",
            'adressVille' => "88400 GERARDMER",
        ],
